...
/**
 * Respuesta paginada para listas de datos en CabaPro.
 * Incluye el contenido de la página y metadatos de paginación.
 */
...
public class PagedResponse<T> {
    ...
    /**
     * Construye un PagedResponse a partir de un Page de Spring Data.
     */
